...
# Chunking - Optimized for fewer embeddings
CHUNK_SIZE = int(os.getenv("CHUNK_SIZE", "2500"))   # Increased from 1100 to 2500 characters
CHUNK_OVERLAP = int(os.getenv("CHUNK_OVERLAP", "250"))  # Adjusted proportionally
